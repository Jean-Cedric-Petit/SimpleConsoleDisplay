 ...
 * Donc pour avoir la transparance, il faudrait travailler avec plusieurs couches, càd plusieur HDC.
 */
...
int main() 
{
    ...
    DrawQuad(50,500,250,500,200,600,700,600,(color),mydc); //Dessine un parallelogramme blanc.


    int vertexX[4]={200,300,100,400};
    int vertexY[4]={400,400,600,600}; //Ca dessine un trapèez normalement!
    int COLORS[4]={(alpha<<24),(alpha<<24)+R,(alpha<<24)+(G<<8),(alpha<<24)+(B<<16)};//NOIR - ROUGE - VERT - BLEU.
